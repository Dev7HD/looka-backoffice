...
export const NAMESPACES = ["common", "nav", "partners", "pois", "auth", "dispatch", "ledger", "drivers", "media", "settings", "errors", "notifications"] as const;

const resources = {
  en: { common: enCommon, nav: enNav, partners: enPartners, pois: enPois, auth: enAuth, dispatch: enDispatch, ledger: enLedger, drivers: enDrivers, media: enMedia, settings: enSettings, errors: enErrors, notifications: enNotifications },
  fr: { common: frCommon, nav: frNav, partners: frPartners, pois: frPois, auth: frAuth, dispatch: frDispatch, ledger: frLedger, drivers: frDrivers, media: frMedia, settings: frSettings, errors: frErrors, notifications: frNotifications },
  es: { common: esCommon, nav: esNav, partners: esPartners, pois: esPois, auth: esAuth, dispatch: esDispatch, ledger: esLedger, drivers: esDrivers, media: esMedia, settings: esSettings, errors: esErrors, notifications: esNotifications },
  ar: { common: arCommon, nav: arNav, partners: arPartners, pois: arPois, auth: arAuth, dispatch: arDispatch, ledger: arLedger, drivers: arDrivers, media: arMedia, settings: arSettings, errors: arErrors, notifications: arNotifications },
} as const;
